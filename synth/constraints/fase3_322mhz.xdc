...
set_input_delay -clock clk_pipeline -min 0.0 [get_ports {rst_n s_axis_tdata[*] s_axis_tvalid s_axis_tlast bbo_tready depth_tready}]
set_input_delay -clock clk_pipeline -max 1.0 [get_ports {rst_n s_axis_tdata[*] s_axis_tvalid s_axis_tlast bbo_tready depth_tready}]
